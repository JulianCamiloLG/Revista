...
class CRUDArticulo
{
    ...
    public function articulo_revision(){
        $this->sql="select a.id id, a.titulo titulo,a.autor autor,a.temas temas,a.estado estado, r.nota1 nota1, r.nota2 nota2, r.nota3 nota3,r.promedio calificacion, r.par par1,r.par2 par2,r.par3 par3
